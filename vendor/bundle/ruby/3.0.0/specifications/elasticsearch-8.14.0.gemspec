# -*- encoding: utf-8 -*-
# stub: elasticsearch 8.14.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<elasticsearch-api>.freeze, ["= 8.14.0"])
    ...
    s.add_dependency(%q<elastic-transport>.freeze, ["~> 8.3"])
    s.add_dependency(%q<elasticsearch-api>.freeze, ["= 8.14.0"])
